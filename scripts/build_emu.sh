...
cd build
[ ! -f ${ROOT_DIR}/emulator/qemu-${QEMU_VERSION}/build/qemu-system-x86_64.p ] && ../configure
[ ! -f ${ROOT_DIR}/emulator/qemu-${QEMU_VERSION}/build/qemu-system-x86_64 ] && make -j$(($(nproc)-1))
